...
# Este ejercicio calcula y devuelve el promedio de una lista de números sumando sus valores y dividiéndolos entre la cantidad de elementos, incluye docstring.